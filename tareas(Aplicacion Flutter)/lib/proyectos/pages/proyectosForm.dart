...
class Proyectosform extends StatefulWidget {
  const Proyectosform({super.key});

  @override
  State<Proyectosform> createState() => _ProyectosformState();
}

class _ProyectosformState extends State<Proyectosform> {
  ...
  Future<void> guardarProyecto() async {
    ...
    try {
      bool exito = await proyectocontroller.crearProyecto(nuevoProyecto);
      if (exito) {
        ScaffoldMessenger.of(context).showSnackBar(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Error al guardar el proyecto")),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Error inesperado al guardar el proyecto")),
      );
    }
  }
